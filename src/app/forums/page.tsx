    ...
    return (
        <div>
            ...
            <Row gutter={24} style={{
                ...
                <Col span={6}>
                    <Card title="新鲜出炉" extra={<a href="https://www.google.com">More</a>} bordered={false}
                          style={cardStyle}>
                        <Popover content={hoverContent11} title="DX书库网页检索 EbookDatabase 0.0.3.1">
                            <a href="https://www.google.com" target="_blank" rel="noreferrer"> 1.DX书库网页检索
                                EbookDatabase 0.0.3.1</a>
                        </Popover>
                        <br/>
                        <Popover content={hoverContent12} title="Sav PDF Viewer v1.14.2-pdf阅读器">
                            <a href="https://www.google.com" target="_blank" rel="noreferrer">2.Sav PDF Viewer
                                v1.14.2-pdf阅读器</a>
                            <br/>
                        </Popover>
                    </Card>
                ...
                <Col span={6}>
                    <Card title="技术分享 New～" extra={<a href="https://www.google.com">More</a>} bordered={false}
                          style={cardStyle}>
                        <a href="https://www.google.com" target="_blank" rel="noreferrer">1.DX书库网页检索 EbookDatabase
                            0.0.3.1</a>
                    </Card>
                </Col>
                <Col span={6}>
                    <Card title="人气热门" extra={<a href="https://www.google.com">More</a>} bordered={false}
                          style={cardStyle}>
                        <a href="https://www.google.com" target="_blank" rel="noreferrer">1.DX书库网页检索 EbookDatabase
                            0.0.3.1</a>
                    </Card>
                ...
                <Col span={6}>
                    <Card title="精华采撷" extra={<a href="https://www.google.com">More</a>} bordered={false}
                          style={cardStyle}>
                        <a href="https://www.google.com" target="_blank" rel="noreferrer">1.DX书库网页检索 EbookDatabase
                            0.0.3.1</a>
                    </Card>
            ...
            <Row style={evenpostStyle}>
                <Col span={2} style={{
                    ...
                    <Button href="https://www.google.com" style={{
                        fontSize: '1rem',
                        marginLeft: '50%',
                        textAlign: 'center'
                    }} type="link">
